# adopted from Abishek Thakur's code:
# https://github.com/abhishekkrthakur/long-text-token-classification/train.py
...
class FeedbackModel(tez.Model):
    def __init__(self, model_name, num_train_steps, learning_rate, hidden_dropout_prob,
        num_labels, steps_per_epoch):
        super().__init__()
...
if __name__ == "__main__":
    ...
    if args.model == "./model/microsoft/deberta-v3-large":
    ...
    valid_samples.sort(key=lambda d: d["text_len"], reverse=False)
